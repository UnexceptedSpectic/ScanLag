...
%   strain_data is a string vector of directories to plates of the same strain
...
out = ["min_std" "growth_mean" "pixel_min" "pixel_max" "percent_std"; ideal_std ideal_mean ideal_min ideal_max min_percent_std];
outStruct = struct;
